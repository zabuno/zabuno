...
somut boşluklar: CORE-08'de altı katalogdan beşi ve PO pipeline'ı (WP03),
CORE-04 Entitlements (WP05), CORE-12 Ledger (WP06), OWASP ASVS denetimi ve
shared-host kapasite probe'u (WP07). Bu satırların **hiçbiri**

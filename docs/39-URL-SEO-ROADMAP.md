...
| 2.0 | **Panel gezintisini fragment'ten gerçek adrese taşı** | **Tamamlandı (2026-08-27)** | `/app/{workspace}/{section}` ve `/platform/{section}`. Ön koşuldu: fragment sunucuya gitmediği için panel ölçülemiyordu. Ölçüm dikişi `docs/46` |

...
/*
    VERİ VE SÖZLEŞME ORTAK BİR DOSYADA (`docs/151`).

    Bu bileşen dokunma sürümüdür ve masaüstü tablosu AYNI bağlamı alır.
    Sözleşme burada kalsaydı, cihaza özgü dosya dokunma bileşeninin
...
} from './memberListSurface';

import type { TeamMemberListSurfaceContext } from './memberListSurface';

type TeamMemberListProps = TeamMemberListSurfaceContext;

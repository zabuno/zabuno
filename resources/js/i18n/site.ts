...
export const siteTranslations = {
    ...
    */
    'site.pageState.title': 'In preparation',
    'site.pageState.headline': 'This page is not live yet.',
    'site.pageState.lede':
        'Content, design, search visibility, and quality checks are being prepared in stages.',
    'site.pageState.maintenanceHeadline': 'This page is undergoing brief maintenance.',
    'site.pageState.maintenanceLede':
        'This page was live and will be back. Other pages continue to work in the meantime.',
    'site.pageState.pageLabel': 'Page',
    'site.pageState.stageLabel': 'Status',
    'site.pageState.updatedLabel': 'Last updated',
    'site.pageState.home': 'Return to the home page',
    'site.pageState.explore': 'Explore available pages',
    'site.pageState.contact': 'Contact us',
    'site.pageState.planned': 'Queued',
    'site.pageState.scaffolded': 'Structure prepared',
    'site.pageState.content_draft': 'Turkish content is being prepared',
    'site.pageState.content_review': 'Content is being reviewed',
    'site.pageState.design_review': 'Visual layout is being prepared',
    'site.pageState.seo_review': 'Search visibility is being checked',
    'site.pageState.qa': 'Final quality checks',
    'site.pageState.approved': 'Waiting to go live',
    'site.pageState.published': 'Live',
    'site.pageState.maintenance': 'Brief maintenance',
    'site.pageState.retired': 'Taken offline',

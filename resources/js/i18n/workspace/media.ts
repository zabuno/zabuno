export const media = {
    ...
    */
    ...
    /*
        FF-226 (MEDIA-C2). Yükleme sihirbazının metinleri buraya TAŞINDI.
        Daha önce `uploadWizardCopy.ts` içindeki geçici bir tabloda
        duruyorlardı: o tablo, anahtarlar kataloğa girene kadar ekranda ham
        anahtar adı görünmesin diye yazılmış bir köprüydü ve kendi kendini
        silmek üzere kuruldu. Anahtarlar artık burada olduğu için köprünün
        tablosu ölü koddur — `wizardText()` katalogtan okur.

        Taşımanın asıl kazancı İngilizce değil ÇEVİRİDİR: köprüdeki metin
        PO boru hattına hiç girmiyordu, yani sihirbaz Türkçe panelde de
        İngilizce konuşuyordu. Sahibin gördüğü ekranın yarısı Türkçe, yarısı
        İngilizceydi ve bu bir çeviri eksiği gibi değil, bitmemiş bir ürün
        gibi görünüyordu.
    */
    // --- Adım göstergesi ---------------------------------------------------
